...
| s11 | Short-lived processes | 🟡 PART | ✅ PASS | 10976978/- | 11000000/- | egress 1.0021 | listed unattributed (?) by Sniffnet |
| s12 | AF_PACKET raw-frame injection | 🟡 PART | ✅ PASS | 4320136/- | 4300000/- | egress 0.9953 | listed unattributed (?) by Sniffnet |
| s13 | io_uring data path | 🟡 PART | ✅ PASS | 26338372/- | 26000000/- | egress 0.9872 | listed unattributed (?) by Sniffnet |
| s14 | sendfile() zero-copy upload | ✅ PASS | ✅ PASS | 35109226/- | 35000000/- | egress 0.9969 | per-program total from the GUI |
...
| s20 | High-rate parallel burst | 🟡 PART | ✅ PASS | 8238110/- | 8300000.000000001/- | egress 1.0075 | listed unattributed (?) by Sniffnet |
| s21 | io_uring download (recv) | 🟡 PART | ✅ PASS | -/25216520 | -/27000000 | ingress 1.0707 | listed unattributed (?) by Sniffnet |
