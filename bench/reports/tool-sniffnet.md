...
| s07 | IPv6 TCP transfer | ✅ PASS | ✅ PASS | -/25232396 | -/27000000 | ingress 1.0701 | per-program total from the GUI |
...
| s11 | Short-lived processes | 🟡 PART | ✅ PASS | 10975460/- | 11000000/- | egress 1.0022 | listed unattributed (?) by Sniffnet |
| s12 | AF_PACKET raw-frame injection | 🟡 PART | ✅ PASS | 4320136/- | 4300000/- | egress 0.9953 | listed unattributed (?) by Sniffnet |
| s13 | io_uring data path | 🟡 PART | ✅ PASS | 26328908/- | 26000000/- | egress 0.9875 | listed unattributed (?) by Sniffnet |
| s14 | sendfile() zero-copy upload | ✅ PASS | ✅ PASS | 35109292/- | 35000000/- | egress 0.9969 | per-program total from the GUI |
...
| s20 | High-rate parallel burst | 🟡 PART | ✅ PASS | 8235936/- | 8300000.000000001/- | egress 1.0078 | listed unattributed (?) by Sniffnet |
| s21 | io_uring download (recv) | 🟡 PART | ✅ PASS | -/25215926 | -/27000000 | ingress 1.0708 | listed unattributed (?) by Sniffnet |
| s22 | splice() zero-copy download | ✅ PASS | ✅ PASS | -/33622420 | -/35000000 | ingress 1.041 | per-program total from the GUI |
