...
| s04 | UDP bulk up+down | ✅ PASS* | ⬜ N/A | -/- | -/- |  | 17978 connection record(s) matched process |
| s05 | ICMP echo flood w/ payload | ❌ FAIL | ⬜ N/A | -/- | -/- |  | 0 connection record(s) matched process |
| s06 | UDP/443 bulk | ✅ PASS* | ⬜ N/A | -/- | -/- |  | 17977 connection record(s) matched process |
| s07 | IPv6 TCP transfer | ✅ PASS* | ⬜ N/A | -/- | -/- |  | 0 connection record(s) matched process |
| s08 | SCTP transfer | ✅ PASS | ⬜ N/A | -/- | -/- |  | 1 connection record(s) matched process |
| s09 | Small-packet UDP/53 flood | ✅ PASS* | ⬜ N/A | -/- | -/- |  | 17829 connection record(s) matched process |
| s10 | Raw IP socket (proto 253) egress | ❌ FAIL* | ⬜ N/A | -/- | -/- |  | 0 connection record(s) matched process; flow seen by dst only |
...
| s20 | High-rate parallel burst | ✅ PASS | ⬜ N/A | -/- | -/- |  | 29 connection record(s) matched process |
