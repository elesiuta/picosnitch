...
| s04 | UDP bulk up+down | ✅ PASS* | ⬜ N/A | -/- | -/- |  | 10000 connection record(s) matched process |
| s05 | ICMP echo flood w/ payload | ❌ FAIL | ⬜ N/A | -/- | -/- |  | 0 connection record(s) matched process |
| s06 | UDP/443 bulk | ✅ PASS* | ⬜ N/A | -/- | -/- |  | 9999 connection record(s) matched process |
...
| s09 | Small-packet UDP/53 flood | ❌ FAIL* | ⬜ N/A | -/- | -/- |  | 9997 connection record(s) matched process |
...
| s15 | sendmmsg batched UDP | ✅ PASS* | ⬜ N/A | -/- | -/- |  | 9998 connection record(s) matched process |
...
| s20 | High-rate parallel burst | ✅ PASS | ⬜ N/A | -/- | -/- |  | 28 connection record(s) matched process |
